package org.example.sharding.yaml;
...
@RestController
public class ShardingYamlTestApp {
    ...
    public static void main(String[] args) {
        SpringApplication.run(ShardingYamlTestApp.class, args);
    }
    
    @PostMapping("/execute")
    public String execute(@RequestBody Param param) throws SQLException {
